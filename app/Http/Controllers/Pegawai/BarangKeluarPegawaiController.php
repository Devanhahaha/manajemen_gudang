...
class BarangKeluarPegawaiController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('pegawaipage.laporan.barang_keluar', compact('barangkeluar'));
    }
    ...
    public function create()
    {
        $barang = Barang::all();
        $pegawai = Pegawai::all();
        return view('pegawaipage.laporan.outbound', compact('barang', 'pegawai'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('barang-keluarPegawai.index')->with('success', 'Data barang keluar berhasil ditambahkan');
    }
    ...
    public function show(BarangKeluar $barangkeluar, $id)
    {
        ...
        return view('pegawaipage.laporan.detail', compact('barangkeluar'));
    }
    ...
    public function destroy(BarangKeluar $barangkeluar, $id)
    {
        $barangkeluar = BarangKeluar::findOrFail($id);
        $barangkeluar->delete();
        return redirect()->route('barang-keluarPegawai.index')->with('Success', 'Data Berhasil Terhapus');
    }
}
